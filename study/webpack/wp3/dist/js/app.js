...
/******/ 	var hotCurrentHash = "32996554a583ce1e4338"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadJs(modName) {
	    ...
	    switch (modName) {
	        case routerArr[1]:
	            __webpack_require__(5).ensure([], function (require) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadJs(jsPath) {
	    ...
	    if (jsPath === './home') {
	        ...
	        !/* require.ensure */(function (require) {
	            currentMod = __webpack_require__(23);
	            currentMod.init(pageDatas.params);
	        }(__webpack_require__));
