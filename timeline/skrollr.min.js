...
function(a, b, wrapperElem,c) {
    ...
    d.prototype.refresh = function(a) {
        var d, e, f = !1;
        for (a === c ? (f = !0, ia = [], Ra = 0, a = wrapperElem.getElementsByTagName("*")) : a.length === c && (a = [a]), d = 0, e = a.length; e > d; d++) {
            var g = a[d],
            h = g,
            i = [],
            j = pa,
...
} (window, document, document.getElementById('skrollr-body'));
